...
GREED_TRIGGERS = {
    "exclusivity_framing": [
        "I only work with {n} {category}s per month in {city}. After that, it's a waitlist.",
        "This system isn't available to everyone. I select partners who are serious about growth.",
        "Most of your competitors will never see this. I don't do mass outreach.",
    ],
    
    "scarcity_calibration": [
        "I have 2 implementation slots left this month. January is already filling up.",
        "At current demand, I'll stop taking new {city} clients by {future_date}.",
        "This pricing is only valid until {end_of_month}. After that, it increases 30%.",
    ],
    
    "time_illusion": [
        "In the time we've been talking, you've probably lost 2-3 booking inquiries.",
        "Every week you wait is another ${weekly_loss} that doesn't come back.",
        "Your competitors are implementing this right now. Not next month. Now.",
    ],
    
    "status_based_closing": [
        "The top {category}s in {city} all have one thing in common: they moved fast on this.",
        "When TripAdvisor ranks {city} {category}s next quarter, where do you want to be?",
        "A year from now, you'll either be ahead of this wave or swimming against it.",
    ],
    
    "narrative_embedding": [
        "Imagine it's 6 months from now. Your phone buzzes at 2am, but you don't need to check it. The system handled it. You wake up to 3 new bookings that came in overnight. That's the reality I'm offering.",
        "Last month, {similar_business} was exactly where you are. Overwhelmed. Losing bookings. Now they have a waitlist problem. That transformation took 30 days.",
        "The owners who are winning right now aren't working harder. They built systems while others were still deciding.",
    ],
    
    "identity_escalation": [
        "You're not the type of owner who watches competitors pass them by.",
        "The question isn't whether you can afford this. It's whether you can afford to be the last {category} in {city} without it.",
        "In 5 years, there will be two types of {category}s: those who adapted and those who closed.",
    ],
    
    "loss_aversion_anchoring": [
        "You've already lost ${months_operating * monthly_loss} since you opened by not having this.",
        "Every day you wait is ${daily_loss} that goes to competitors with faster response times.",
        "The ROI isn't hypothetical. You're losing this money right now. Today.",
    ],
    
    "implied_inevitability": [
        "This isn't about if you'll automate. It's about whether you do it before or after your competitors.",
        "Every business in hospitality will have this in 3 years. The question is: are you first or last?",
        "The owners who wait always say the same thing: 'I wish I'd done this sooner.'",
    ],
}
...
PREEMPTIVE_OBJECTIONS = {
    "price": {
        ...
        "preemptive_script": "Before we talk numbers — this isn't a cost. It's a reallocation. You're already spending ${monthly_loss}/month on lost bookings, no-shows, and manual work. We're just redirecting a fraction of that waste into a system that eliminates it.",
        "embedded_reframe": "The real question isn't 'can I afford this?' — it's 'can I afford to keep losing ${monthly_loss} every month?'",
    },
    
    "time": {
        "objection": "I don't have time to implement this",
        "preemptive_script": "I know you're stretched thin — that's exactly why this exists. Implementation takes 2-3 hours of your time total. After that, you get 15+ hours back every week. The people who 'don't have time' are always the ones who need this most.",
        "embedded_reframe": "You don't have time NOT to do this. Every week you wait is another 15 hours you can't get back.",
    },
    
    "trust": {
        "objection": "I've tried tech/AI before and it didn't work",
        "preemptive_script": "Most 'AI solutions' are generic software that doesn't understand hospitality. This is different — it's built specifically for {category}s in {city}. {proof_point}. But I get the skepticism. That's why there's a 30-day guarantee: if you don't see results, you don't pay.",
        "embedded_reframe": "The difference between what failed before and this? Specificity. Generic tools fail. Custom systems built for YOUR business type succeed.",
    },
    
    "need": {
        "objection": "We're doing fine without it",
        "preemptive_script": "That's what the best businesses say — until they see the numbers. {business_name} is doing well, but 'well' isn't the same as 'optimized.' You're leaving ${monthly_loss}/month on the table. That's not a crisis — it's an opportunity.",
        "embedded_reframe": "'Fine' is the enemy of great. The question is: do you want to stay fine, or do you want to dominate?",
    },
    
    "timing": {
        "objection": "This isn't the right time",
        "preemptive_script": "There's never a 'perfect' time — but there is a cost to waiting. Every month you delay is another ${monthly_loss} lost. Meanwhile, your competitors are implementing right now. The best time was 6 months ago. The second best time is today.",
        "embedded_reframe": "The owners who wait always say the same thing later: 'I wish I'd done this sooner.'",
    },
    
    "complexity": {
        "objection": "This seems complicated",
        "preemptive_script": "It looks complex from the outside — but that's my job, not yours. You give me 3 hours total. I handle everything else. Your only job is to watch the results come in.",
        "embedded_reframe": "The system is sophisticated. Your experience with it is simple: set it up once, benefit forever.",
    },
    
    "personal_touch": {
        "objection": "My clients expect ME, not a bot",
        "preemptive_script": "This doesn't replace you — it amplifies you. The AI handles the repetitive stuff (confirmations, reminders, FAQs) so you can spend MORE time on the personal touches that matter. Your clients get faster response AND more of your attention.",
        "embedded_reframe": "Right now, you're spending 70% of your time on tasks a system could do. Imagine spending that 70% on what only YOU can do.",
    },
}
