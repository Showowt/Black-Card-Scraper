            ...
            <Card data-testid="response-result">
              ...
              <CardContent className="space-y-4">
                <div className="p-4 bg-green-50 dark:bg-green-950/20 rounded-lg border border-green-200 dark:border-green-900">
                  <p className="text-sm whitespace-pre-wrap">{responseResult.draftResponse}</p>
                </div>
              ...
              <CardContent className="space-y-4">
                <div className="space-y-2">
                  ...
                  <div className="p-4 bg-blue-50 dark:bg-blue-950/20 rounded-lg border border-blue-200 dark:border-blue-900">
                    <p className="text-sm whitespace-pre-wrap">{objectionResult.suggestedResponse}</p>
                  </div>
                </div>
                ...
                <div className="p-3 bg-amber-50 dark:bg-amber-950/20 rounded-lg border border-amber-200 dark:border-amber-900">
                  <div className="flex items-center gap-2 mb-1">
                    ...
                    <span className="text-sm font-medium">Tone Guidance</span>
                  </div>
                  <p className="text-sm text-muted-foreground">{objectionResult.toneGuidance}</p>
                </div>
              </CardContent>
            </Card>
          )}
